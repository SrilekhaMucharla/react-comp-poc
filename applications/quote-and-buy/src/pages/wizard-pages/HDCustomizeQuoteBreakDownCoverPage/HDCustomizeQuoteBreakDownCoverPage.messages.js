...
export const breakDownCoverQuestion = 'Do you need RAC breakdown cover?';
...
export const continueButtonText = 'Confirm your selected RAC cover';
export const noCoverText = 'Continue without breakdown';
export const continueButtonDisabledText = 'Confirm your selected RAC cover';
...
export const noCoverageModalHeader = 'Please confirm you don\'t want any RAC cover';
export const noCoverageContent = ' ';
export const noCoverageContinueText = 'Confirm';
...
export const misfuelling = 'Misfuelling in the UK';
...
export const preSelectText = 'Preselected VIA ';
...
export const removedPopupMessage = 'Your cover won\'t include RAC breakdown cover.';
...
export const compareTheMarketLabel = 'Compare The Market';
export const moneySupmarketLabel = 'Money Supermarket';
export const confusedComLabel = 'Confused.com';
export const goCompareLabel = 'Go-compare';
export const quoteZoneLabel = 'QuoteZone';
export const uSwitchLabel = 'uSwitch';
export const insurerGroupLabel = 'Insurer Group';
export const experianLabel = 'Experian';
export const defaultLabel = 'Compare The Market';
