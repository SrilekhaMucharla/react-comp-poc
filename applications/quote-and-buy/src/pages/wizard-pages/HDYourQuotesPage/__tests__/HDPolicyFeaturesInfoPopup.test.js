...
import HDPolicyFeaturesInfoPopup from '../HDPolicyFeaturesInfoPopup';
...
describe('<HDPolicyFeaturesInfoPopup />', () => {
    createPortalRoot();
    ...
    const wrapper = mount(
        <Provider store={store}>
            <HDPolicyFeaturesInfoPopup pageMetadata={pageMetadataMock} />
        </Provider>
    );
