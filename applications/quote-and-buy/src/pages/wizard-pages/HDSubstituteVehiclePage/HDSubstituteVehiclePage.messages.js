...
export const pageInfoText = 'Just to clarify, a small courtesy car will be provided if your car can be repaired. Adding substitute vehicle cover provides you with a like-for-like vehicle if your car’s ever written off or can’t be repaired after an accident (even if the accident wasn’t your fault).';
export const pageLinkText = 'Read the Insurer Product Information document';
export const pageAddSubstituteVehicleTitle = (price) => `Do you need substitute vehicle cover for £${price}?`;
export const no = 'No';
export const yes = 'Yes';
export const popupMessage = (price) => `Great! You've added substitute vehicle, £${price} has been added to your total price.`;
